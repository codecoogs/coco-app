 ...
 * Server Components where set succeeds) and middleware. httpOnly keeps tokens out of JS
 ...
 * not be readable. Path/sameSite/secure stay aligned with the server so middleware can
