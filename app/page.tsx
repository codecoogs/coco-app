    ...
    <>
      <div className="relative flex min-h-screen flex-col bg-zinc-900">
        <div className="absolute left-4 top-4 sm:left-6 sm:top-6">
          ...
          >
            <Image
              src="/images/logos/coco-border.webp"
              alt="CodeCoogs"
              width={400}
              height={260}
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-5 py-14 sm:px-8">
          <div className="w-full max-w-sm">
            <h1 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">
              Welcome to Coco
            </h1>
            <p className="mt-3 text-base text-zinc-300">
              The CodeCoogs platform for member points, events, and more. Please
              sign in to continue.
            </p>
...
function HomePageFallback() {
  return <div className="flex min-h-screen flex-col bg-zinc-900" />;
}
