...
function isWelcomeBack(createdAt: string, lastSignInAt: string | undefined): boolean {
...
export function DashboardNavbar() {
  ...
  const showWelcomeBack = isWelcomeBack(user.created_at, user.last_sign_in_at ?? undefined);
