...
-- One row per active assignment in user_positions; users with multiple positions get multiple rows.
-- The app merges rows (unions permissions, ORs is_admin, joins titles).
--
-- Columns: auth_id, user_id, positionTitle, role_name, is_admin, permissions (text[]).
--
